<div class="flex items-start max-md:flex-col">
    <div class="me-10 w-full pb-4 md:w-[220px]">
        <flux:navlist class="hidden md:block mb-6">
            ...
            <flux:navlist.settings-item icon="moon" :href="route('settings.appearance')" :current="request()->routeIs('settings.appearance')" wire:navigate>{{ __('Appearance') }}</flux:navlist.settings-item>
        </flux:navlist>
