<div class="flex items-start max-md:flex-col my-4 md:my-0">
    <div class="me-10 w-full pb-2 md:w-[220px]">
        <flux:navlist class="hidden md:block mb-6 ">
            ...
            <flux:navlist.settings-item icon="message-square-heart" :href="route('chatbot.faqs')" :current="request()->routeIs('chatbot.faqs')" wire:navigate>{{ __('FAQs') }}</flux:navlist.settings-item>
