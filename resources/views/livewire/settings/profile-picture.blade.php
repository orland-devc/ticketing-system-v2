...
<div class="flex flex-col items-center gap-6 p-6 rounded-xl bg-gradient-to-br from-zinc-50 to-zinc-100 dark:from-zinc-900 dark:to-zinc-800 border border-zinc-200 dark:border-zinc-700">
    ...
    >
        ...
        <!-- Status Badge -->
        <div class="absolute -bottom-1 -right-1 bg-green-500 w-8 h-8 rounded-full border-4 border-white dark:border-zinc-800 flex items-center justify-center">
            <i class="fas fa-robot text-white text-sm"></i>
        </div>
    </div>

    <div class="text-center">
        <h3 class="text-lg font-bold text-zinc-900 dark:text-white">{{ $botSettings->name }}</h3>
        <p class="text-sm text-zinc-500 dark:text-zinc-400">Bot Profile Picture</p>
    </div>
